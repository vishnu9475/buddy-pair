...
useEffect(() => {
  ...
  return (
    <div className="relative min-h-screen bg-purple-950 overflow-x-hidden">
      {/* PAGE CONTAINER */}
      <div
  className="relative z-10">
  <ProfileCard29 scrollY={smoothY} maxScroll={600} onBack={() => navigate(-1)} ButoonText = "Profile Complete"/>
</div>
        {/* WHITE SHEET */}
       <div
