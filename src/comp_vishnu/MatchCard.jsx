...
const MatchCard = ({ image, name, age, location, distance, matchPercentage, isOnline }) => {
  return (
    <div className="relative w-full max-w-[280px] aspect-[3/4] rounded-[40px] p-[6px] bg-gradient-to-b from-[#E996D1] to-[#D379B8] shadow-lg overflow-hidden group">
      <div className="relative w-full h-full rounded-[34px] overflow-hidden bg-gray-200">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 bg-[#EE99D5]/80 backdrop-blur-md px-5 py-1 rounded-b-2xl border-x border-b border-white/30">
          <span className="text-[#e5e0e3] font-michroma text-[11px] font-bold whitespace-nowrap">
        ...
        <div className="absolute bottom-20 left-1/2 -translate-x-1/2 bg-black/30 backdrop-blur-md px-4 py-1 rounded-full border border-white/20">
          <span className="text-[#e3e0e2] font-michroma text-[11px] font-medium whitespace-nowrap">
            {distance} away
          </span>
        </div>
        ...
        <div className="absolute bottom-4 left-0 right-0 text-center flex flex-col items-center">
          <div className="flex items-center gap-2">
            <h3 className="text-[#f5f5f5] font-michroma text-xl font-bold">
              {name}, {age}
            </h3>
          ...
          <p className="text-[#e9e3e7] font-michroma text-[10px] uppercase tracking-[0.3em] font-bold mt-1">
            {location}
          </p>
        </div>
